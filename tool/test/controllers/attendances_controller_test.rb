...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { entry_id: @attendance.entry_id, join_yn: @attendance.join_yn, number: @attendance.number }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { entry_id: @attendance.entry_id, join_yn: @attendance.join_yn, number: @attendance.number }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
